  ...
  return (
    <>
      <div className="bg-gray_800 flex md:flex-col sm:flex-col flex-row font-mulish md:gap-[20px] sm:gap-[20px] items-start mx-[auto] w-[100%]">
        <div className="bg-gray_800 flex flex-col items-center justify-start mb-[492px] md:pl-[20px] sm:pl-[20px] md:pr-[20px] sm:pr-[20px] pt-[37px] md:w-[100%] sm:w-[100%] w-[18%]">
